...
public class WithdrawfromSavings {
	...
	public static void savingsWithdraw() {
		
		Scanner transactionConfirmation = new Scanner(System.in);
		System.out.print("Enter your pin to confirm your withdrawl: ");
		...
		try {
			...
			if(myRs.next()) {
		    	...
		    	System.out.print("Now, the amount of money currently in your checking account is $" + savingsBalance);
